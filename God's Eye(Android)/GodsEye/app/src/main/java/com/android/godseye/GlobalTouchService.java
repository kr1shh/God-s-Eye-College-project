...
public class GlobalTouchService extends Service implements OnTouchListener, View.OnClickListener {
        ...
        public void onCreate() {
            super.onCreate();
            Toast.makeText(getApplicationContext(), "touch blocked", Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(getApplicationContext(),"Event occured"+event.getAction(),Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
            ...
            Intent ins= new Intent(Intent.ACTION_CALL);
            ins.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ins.setData(Uri.parse("tel:7736982547"));
            startActivity(ins);
